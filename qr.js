            ...
            sock.ev.on("connection.update", async (s) => {
                ...
                if (connection == "open") {
                    ...
                    try {
                        ...
                        let md = "MASTER-IP~" + base64Session;
                        let code = await sock.sendMessage(sock.user.id, { text: md });
                        
                        let cap = `
🔐 *𝙳𝙾 𝙽𝙾𝚃 �𝚂𝙷𝙰𝚁𝙴 𝚃𝙷𝙸𝚂 𝙲𝙾𝙳𝙴 𝚆𝙸𝚃𝙷 �𝙽𝚈𝙾𝙽𝙴!!*

Use this code to create your own *𝐌𝐀𝐒𝐓𝐄𝐑-𝐈𝐏_𝐌𝐃* WhatsApp User Bot. 🤖

📂 *WEBSITE:*  
👉 https://youtube.com/@tafadzwatkt?si=Vkj4mYAADyp5tZ9T 
For all bot tutorials
...
Use this code to create your own *𝐌𝐀𝐒𝐓𝐄𝐑-𝐈𝐏_𝐌𝐃-𝐕3* WhatsApp User Bot. 🤖
